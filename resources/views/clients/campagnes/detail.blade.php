...
@php( $docs = App\Http\Controllers\Client\PlanMediaController::getDocCampagne($cid))
@php($cheminfichier = 'upload'.DIRECTORY_SEPARATOR.'campagnes'.DIRECTORY_SEPARATOR.$cid)
@section('content')
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6">
            @include('clients.tableaux.planMediaCampagneBilan')
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            @include('clients.campagnes.docampagne', $docCamp)

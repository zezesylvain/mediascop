<div class="container-fluid">
    <form id="essai" name="essai" method="post" action="{{route("$mod.filterCampagne", $action)}}" autocomplete="on">
        {{ csrf_field() }}
        <input type="hidden" id="formok" name="filteroperation" value="ok">
        <input type="hidden" name="action" value="{{$action}}">
        @if(isset($valide))
            <input type="hidden" name="pvalider" value="{{$valide}}">
        @endif
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="chosen-select-single mg-b-20 form-group" id="annonceurfilteroperationitem">
                    <label  for="annonceurfilteroperation">Annonceur</label>
                    <select name="annonceurfilteroperation" id="annonceurfilteroperation" data-placeholder="" class="chosen-select form-control" tabindex="-1">

                    ...
                    <div class="hpanel email-compose mg-b-15">
                        ...
                        <form method="post" class="form-horizontal" action="{{route ("message.store")}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group chosen-select-single">
                                ...
                                <div class="col-sm-11">
                                    <div class="chosen-select-single form-group">
                                        <select class="select2_demo_2 form-control" multiple="multiple" name="users[]" id="users">
                                            @foreach($users as $user)
                                                @php($selected = $user['id'] == $expediteurID ? "selected" : "")
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-11">
                                    <input type="text" class="form-control input-sm" placeholder="Enter Message subject" name="objet" value="Re:{{$objet}}">
                                </div>
                            </div>
                            ...
                            <div class="panel-body no-padding">
                                <textarea class="summernote6" name="texte" rows="3"></textarea>
                                <hr>
                                <div class="panel-csm">
                                    <p>
                                    Le {{$date2Fr ($dateMessage,"d.m.Y")}}, à {{$date2Fr ($dateMessage,"H:i")}}, <b>{{$expediteur}}</b> à écrit:<hr> {!! $message !!}
                                    </p>
                                </div>
                                <div id="fileList"></div>
                            </div>
                            ...
                            <div class="panel-footer">
                                <div class="pull-right">
                                    <div class="btn-group">
                                        ...
                                        <button class="btn btn-default"><i class="fa fa-trash"></i> Effacer</button>
                                    </div>
                                </div>

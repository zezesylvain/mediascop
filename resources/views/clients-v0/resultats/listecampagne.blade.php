        ...
        <table class="table table-striped table-bordered table-hover dataTables-listing liste-campagne">
            ...
            @foreach ($detailDesCampagnes AS $cid => $row)
                ...
                <tr>
                    ...
                    <td class="center">
<!--                        <button data-toggle="modal" data-target="#listeCampagneModal"
                                onclick="getCampagneDetail('{{$cid}}')">
                            <i class="fa fa-file-text-o"> </i>
                        </button>-->
                        <a href="{{route('reporting.detailCampagne',encrypt($cid))}}" target="_blank" class="" title="Voir  détail campagne!">
                            <i class="fa fa-file-text-o"> </i>
                        </a>
                    </td>
                </tr>

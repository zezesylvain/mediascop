...
class ReportingController extends AdminController
{
    ...
    public static function built($donnees){
        ...
        Session::put('Reprting.Data', $lesDonnees) ;
        $data = compact('lesDonnees', 'secteurs','natures','route','medias', 'donnees','nbrsecteur',
                    'nbrnature','nbrmedia','date_fin','date_debut', 'hauteur', 'hauteur2') ;
    ...
    public static function makeReportingData(array $donnees):array{
        ...
        $listeTableaux = [
                ...
                'investParCible', 'investParFormat', 'investParNature',
        ...
        foreach($donnees AS $row):
            ...
            foreach($param AS $v):
                ...
                $$v = $paramName[$v][$row[$v]] ;
                self::incrementValueInMultiArray($tableaux[$v], $$v, 'invest', $tarif) ;
                self::incrementValueInMultiArray($tableaux[$v], $$v, 'insertion', $insertion) ;
            endforeach ;
        ...
        return compact('lesDate' , 'dateMois' , 'detailDesCampagnes', 'investParAnnonceurEtParMedia',
                ...
                'investParCible', 'investParFormat', 'investParNature', 'tableaux',

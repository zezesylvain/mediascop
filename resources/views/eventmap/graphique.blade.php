    ...
    @inject("highChart", "\App\Http\Controllers\Charts\HighchartController")
        @if($listeDesMap !== null)
            {!! $highChart::makeHighchartJS("insertParLocalite", env('EVENTMAP_INSERTPARLOC'), $listeDesMap['insertParLocalite']) !!}
            {!! $highChart::makeHighchartJS("investParLocalite", env('EVENTMAP_INVESTPARLOC'), $listeDesMap['investParLocalite']) !!}
            {!! $highChart::makeHighchartJSColor("insertParAnnonceur", env('EVENTMAP_INSERTPARAN'), $listeDesMap['insertParAnnonceur'], $listeDesMap['lesCouleurs']) !!}
            {!! $highChart::makeHighchartJSColor("investParAnnonceur", env('EVENTMAP_INVESTPARAN'), $listeDesMap['investParAnnonceur'], $listeDesMap['lesCouleurs']) !!}

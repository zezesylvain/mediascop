                                            ...
                                            <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                                ...
                                                @if($valide == 0)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th data-field="date" data-editable="true" data-editable-type="date"  data-editable-viewformat="dd/mm/yyyy" data-editable-format="yyyy-mm-dd">Date</th>
                                                        {!! $thDuree !!}
                                                        <th data-field="support" data-editable="true" data-editable-type="select" data-editable-source="[{{$source}}]">Support</th>
                                                        <th>Titre de campagne</th>
                                                        @if($action != 'HORS-MEDIA')
                                                            <th data-field="tarif" data-editable="true" data-editable-type="text">Tarif</th>
                                                            <th data-field="coeff" data-editable="true" data-editable-type="text">Coeff</th>
                                                        @endif
                                                       {{-- {!! $thHorsMedia !!}--}}
                                                        <th>Agent de saisie</th>
                                                        <th>Erreur</th>
                                                        <th>
                                                            <input type="checkbox" onChange="checkboxChecker('listpub', this.checked, '{{count ($listpub)}}');">
                                                        </th>
                                                    </tr>
                                                    </thead>
                                                @endif

...
class ReportController extends AdminController
{
    ...
    public static function built($donnees){
        ...
        $natures = Nature::orderBy('name', 'ASC')->get()->toArray();
        $medias = Media::orderBy('name', 'ASC')->get()->toArray();
        //$sect = Secteur::get()->toArray();
        //dd($secteurs, $sect);
    ...
    public function chercherAnnonceursBySecteur(Request $request){
        ...
        return view ("clients.formReporting.listeAnnonceurs", compact ('datas','nbrDatas'))->render ();
    }

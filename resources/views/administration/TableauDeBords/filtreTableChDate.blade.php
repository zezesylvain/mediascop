    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <select class="form-control chosen-select" name="operateur[{{$i}}]" id="operateur{{$i}}">
                ...
                <option value="NOT LIKE">DIFFERENT</option>
                {{--<option value="=">=</option>--}}
                <option value="<"><</option>
                <option value=">">></option>
                <option value="<="><=</option>
                <option value=">=">>=</option>
                {{--<option value="!=">N'EST PAS EGALE</option>--}}
            </select>
        </div>
        <div class="col-sm-8">
            <input type="text" class="form-control datetimepickerjs" name="champsValues[{{$i}}]" id="{{$champ}}" >

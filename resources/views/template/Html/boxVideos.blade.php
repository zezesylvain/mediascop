                ...
                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                        ...
                        @foreach($videos as $r)
                            ...
                            <div class="product-tab-list tab-pane fade {{$activeIn}}" id="single-tab{{$i}}" style="height: 250px;overflow-y: auto;">
                                <video width="100%" height="240px" controls>
                                    ...
                                    <source src="{{$filelink}}" type="video/ogg">
                    ...
                    <ul id="single-product-tab">
                        ...
                        @foreach($videos as $r)
                            ...
                            ?>
                            <li class="{{$active}}">
                                <a href="#single-tab{{$i}}" onclick="sendData('docID={{$r['id']}}','{{route ('ajax.getMediaDetail')}}','detailsVideoItem')" title="{{$r['name']}}"><i class="fa fa-television fa-3x"></i></a>
                            </li>
                        @endforeach
                    </ul>
                </div>
                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                    <div id="detailsVideoItem">
                        {!! \App\Http\Controllers\Administration\TableauDeBordController::getDetailMedias ($videos[0]['id']) !!}
                    </div>
                </div>
            </div>
        </div>
